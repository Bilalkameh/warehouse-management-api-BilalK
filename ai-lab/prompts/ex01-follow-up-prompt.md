...
C:\Users\User\warehouse-management-api-BilalK\tests\Warehouse.Api.UnitTests\Queries\Products\GetExpiringSoonProductsHandlerTests.cs(28,18):
error CS1061: 'ProductBuilder' does not contain a definition for 'WithExpiryDate' and no accessible extension method 'WithExpiryDate'
accepting a first argument of type 'ProductBuilder' could be found (are you missing a using directive or an assembly reference?) 
[C:\Users\User\warehouse-management-api-BilalK\tests\Warehouse.Api.UnitTests\Warehouse.Api.UnitTests.csproj]

The builder class currently contains:
