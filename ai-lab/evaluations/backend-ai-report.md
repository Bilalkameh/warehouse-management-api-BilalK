I would say the best prompt yielded the best results and that the prompt for exercise 3.
...
--------------------------------------------------------------
Humar corrections:
In exercise 2 and 7 i had to make manual changes and follow up prompts to fix the code but in its majority it was good.


Lessons Learned:

Don't over engineer prompts where it is not needed and put them on GPT 5.6 Sol Very because that might eat half your limit and then yield mediocre results.